...
def secondPageFakultetF1(message):
    if message.text == kelesi:
        ...
        cursor.execute("SELECT EXISTS(SELECT id FROM db_f_1 LIMIT 1)")
        ...
        cursor.execute("SELECT EXISTS(SELECT user_name FROM db_f_1 LIMIT 1)")
        ...
        cursor.execute("SELECT EXISTS(SELECT user_surname FROM db_f_1 LIMIT 1)")
        ...
        cursor.execute("SELECT EXISTS(SELECT user_id FROM db_f_1 LIMIT 1)")
